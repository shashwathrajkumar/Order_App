...
class Munch extends StatefulWidget {
  @override
  _MunchState createState() => _MunchState();
}

class _MunchState extends State<Munch> {
  int quantity = 1;
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} Munch added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "Munch Regular", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
