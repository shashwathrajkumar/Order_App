...
class Perkdouble extends StatefulWidget {
  @override
  _PerkPageState createState() => _PerkPageState();
}

class _PerkPageState extends State<Perkdouble> {
  int quantity = 1;
        ...
        child: Column(
          ...
          children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} Perk Double added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "Perk Double", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
            ...
            GridView.count(
              ...
              children: [
                buildProductButton('Perk Packet', 'icons/perk-packet.jpeg'),
          ...
          onPressed: () {
            switch(productName) {
              case "Perk Regular":
                ...
                break;
              case "Perk Packet":
                Navigator.pushNamed(context, '/perkpacket');
                break;
            }
          },
          style: ButtonStyle(
