...
class Fivestarpacket extends StatefulWidget {
  @override
  _FivestarPageState createState() => _FivestarPageState();
}

class _FivestarPageState extends State<Fivestarpacket> {
  int quantity = 1;
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('Fivestar Packet  Netwt. 200g')
              ],
            ),
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} Fivestar Packet added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "Fivestar Packet", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
