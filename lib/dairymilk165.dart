...
class Dairymilk165Page extends StatefulWidget {
  @override
  _DairymilkPageState createState() => _DairymilkPageState();
}

class _DairymilkPageState extends State<Dairymilk165Page> {
  int quantity = 1;
  double price = 50.0; // Initial price
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('Dairy Milk Regular  Netwt. 165g')
              ],
            ),
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} Dairy Milk (165g) added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "Dairy Milk (165g)", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
