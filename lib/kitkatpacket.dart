...
class Kitkatpacket extends StatefulWidget {
  @override
  _KitKatState createState() => _KitKatState();
}

class _KitKatState extends State<Kitkatpacket> {
  int quantity = 1;
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} KitKat Packet added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "KitKat Packet", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
