...
class _PerkPageState extends State<Perk> {
  int quantity = 1;
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} Perk added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "Perk Regular", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
