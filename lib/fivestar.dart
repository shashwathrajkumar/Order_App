...
class _FivestarPageState extends State<Fivestar> {
  int quantity = 1;
  double price = 5.0; // Initial price
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('Fivestar Regular  Netwt. 10g')
              ],
            ),
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} Fivestar added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "Fivestar", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
