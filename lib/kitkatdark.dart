...
class Kitkatdark extends StatefulWidget {
  @override
  _KitKatState createState() => _KitKatState();
}

class _KitKatState extends State<Kitkatdark> {
  int quantity = 1;
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} KitKat Dark added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "KitKat Dark", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
