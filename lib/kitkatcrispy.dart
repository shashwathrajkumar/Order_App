...
class Kitkatcrispy extends StatefulWidget {
  @override
  _KitKatState createState() => _KitKatState();
}

class _KitKatState extends State<Kitkatcrispy> {
  int quantity = 1;
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('KitKat Crispy Creamy  Netwt. 40g')
              ],
            ),
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} KitKat Crispy Creamy added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "KitKat Crispy", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
            ...
            GridView.count(
              ...
              children: [
                ...
                buildProductButton('KitKat Regular', 'icons/kitkat-regular.jpg'),
              ],
            ),
          ],
        ),
          ...
          onPressed: () {
            switch(productName) {
              ...
              case "KitKat Packet":
                ...
                break;
              case "KitKat Regular":
                Navigator.pushNamed(context, '/kitkat');
            }
          },
          style: ButtonStyle(
            backgroundColor: MaterialStateProperty.all<Color>(
