...
class DairymilksilkPage extends StatefulWidget {
  @override
  _DairymilkPageState createState() => _DairymilkPageState();
}

class _DairymilkPageState extends State<DairymilksilkPage> {
  int quantity = 1;
  double price = 75.0; // Initial price
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              ...
              child: Image.asset(
                'icons/dairymilk-silk-regular.jpg',
            ...
            Row(
              ...
              children: [
                Text('Dairy milk Silk regular  Netwt. 100g')
              ],
            ),
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} Dairy Milk Silk added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "Dairy Milk Silk", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
            ...
            GridView.count(
              ...
              children: [
                ...
                buildProductButton(
                    'Dairy Milk Silk Fruit n Nut', 'icons/dairymilk-silk-fruitnut.jpg'),
              ],
            ),
          ],
        ),
