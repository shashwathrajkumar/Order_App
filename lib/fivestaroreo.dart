...
class Fivestaroreo extends StatefulWidget {
  @override
  _FivestarPageState createState() => _FivestarPageState();
}

class _FivestarPageState extends State<Fivestaroreo> {
  int quantity = 1;
  double price = 40.0; // Initial price
        ...
        child: Column(
          ...
          children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} Fivestar Oreo added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "Fivestar Oreo", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
            ...
            GridView.count(
              ...
              children: [
                buildProductButton('Fivestar 3D', 'icons/fivestar-3D.jpg'),
                buildProductButton('Fivestar Packet', 'icons/fivestarpacket.jpg'),
                buildProductButton('Fivestar Regular', 'icons/fivestar-regular.jpg'),
              ],
            ),
          ],
        ),
    ...
    return Column(
      children: [
        ...
        ElevatedButton(
          onPressed: () {
            switch(productName) {
              case "Fivestar Regular":
                Navigator.pushNamed(context, '/fivestar');
                break;
              case "Fivestar Packet":
                Navigator.pushNamed(context, '/fivestarpacket');
                break;
              case "Fivestar 3D":
                Navigator.pushNamed(context, '/fivestar3D');
            }
