...
class Perkpacket extends StatefulWidget {
  @override
  _PerkPageState createState() => _PerkPageState();
}

class _PerkPageState extends State<Perkpacket> {
  int quantity = 1;
  double price = 70.0; // Initial price
        ...
        child: Column(
          ...
          children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} Perk Packet added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "Perk Packet", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
            ...
            GridView.count(
              ...
              children: [
                buildProductButton('Perk Regular', 'icons/perk-regular.jpg'),
                buildProductButton('Perk Double', 'icons/perk-double.jpg'),
              ],
            ),
          ],
        ),
      ...
      children: [
        ...
        ElevatedButton(
          onPressed: () {
            switch(productName) {
              case "Perk Regular":
                Navigator.pushNamed(context, '/perk');
                break;
              case "Perk Double":
                Navigator.pushNamed(context, '/perkdouble');
                break;
            }
          },
          style: ButtonStyle(
