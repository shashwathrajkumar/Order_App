...
class DairymilkbubblyPage extends StatefulWidget {
  @override
  _DairymilkPageState createState() => _DairymilkPageState();
}

class _DairymilkPageState extends State<DairymilkbubblyPage> {
  int quantity = 1;
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('Dairy Milk Silk Bubbly  Netwt. 100g')
              ],
            ),
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} Dairy Milk Bubbly added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "Dairy Milk Bubbly", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
