...
class DairymilkPage extends StatefulWidget {
  @override
  _DairymilkPageState createState() => _DairymilkPageState();
}

class _DairymilkPageState extends State<DairymilkPage> {
  int quantity = 1;
  double price = 10.0; // Initial price
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('Dairy Milk Regular  Netwt. 10g')
              ],
            ),
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} Dairy Milk added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "Dairy Milk", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
            ...
            GridView.count(
              ...
              children: [
                buildProductButton(
                    'Dairy Milk 165g', 'icons/dairymilk-165g.jpg'),
                buildProductButton('Dairy Milk Silk Bubbly',
                    'icons/dairymilk-silk-bubbly.jpeg'),
                buildProductButton('Dairy Milk Silk Fruit n Nut',
                    'icons/dairymilk-silk-fruitnut.jpg'),
                buildProductButton(
                    'Dairy Milk Silk', 'icons/dairymilk-silk-regular.jpg'),
              ],
            ),
          ],
        ),
    ...
    return Column(
      children: [
        ...
        ElevatedButton(
          onPressed: () {
            switch (productName) {
              case "Dairy Milk 165g":
                Navigator.pushNamed(context, '/dairymilk165');
                break;
              case "Dairy Milk Silk Bubbly":
                Navigator.pushNamed(context, '/dairymilkbubbly');
                break;
              case "Dairy Milk Silk Fruit n Nut":
                Navigator.pushNamed(context, '/dairymilkfn');
                break; // add break statement to prevent fall-through
              case "Dairy Milk Silk":
                Navigator.pushNamed(context, '/dairymilksilk');
                break; // add break statement to prevent fall-through
            }
          },
          style: ButtonStyle(
