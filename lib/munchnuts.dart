...
class Munchnuts extends StatefulWidget {
  @override
  _MunchState createState() => _MunchState();
}

class _MunchState extends State<Munchnuts> {
  int quantity = 1;
  double price = 25.0; // Initial price
          ...
          children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} Munch Nuts added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "Munch Nuts", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
            ...
            GridView.count(
              ...
              children: [
                ...
                buildProductButton('Munch Packet', 'icons/munch-packet.jpg'),
          ...
          onPressed: () {
            switch(productName) {
              ...
              case "Munch Max":
                ...
                break;
              case "Munch Packet":
                Navigator.pushNamed(context, '/munchpacket');
            }
          },
          style: ButtonStyle(
            backgroundColor: MaterialStateProperty.all<Color>(
