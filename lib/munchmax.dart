...
class Munchmax extends StatefulWidget {
  @override
  _MunchState createState() => _MunchState();
}

class _MunchState extends State<Munchmax> {
  int quantity = 1;
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} Munch Max added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "Munch Max", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
