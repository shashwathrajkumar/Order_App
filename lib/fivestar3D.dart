...
class Fivestar3d extends StatefulWidget {
  @override
  _FivestarPageState createState() => _FivestarPageState();
}

class _FivestarPageState extends State<Fivestar3d> {
  int quantity = 1;
  double price = 35.0; // Initial price
          ...
          children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text('${quantity} Fivestar 3D added to cart!'),
                    ));
                    context.read<Cart>().addItem(CartItem(
                        "Fivestar 3D", quantity, totalPrice)); // Example item
                    setState(() {
                      quantity = 1;
                    });
                  },
            ...
            GridView.count(
              ...
              children: [
                ...
                buildProductButton('Fivestar Oreo', 'icons/fivestar-oreo.jpg'),
          ...
          onPressed: () {
            switch(productName) {
              case "Fivestar Regular":
                ...
                break;
              case "Fivestar Oreo":
                Navigator.pushNamed(context, '/fivestaroreo');
                break;
